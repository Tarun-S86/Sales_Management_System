...
def ad():
    ...
    pos = binary_search('products.txt', cn)
...
if __name__=="__main__":
    ...
    label=Label(root,text="ADD SALES INFO",font="bold",fg="Blue")
    ...
    label1=Label(root,text="Customer name:",bg='light blue')
    label1.place(x=250,y=120)

    label2=Label(root,text="Customer ID:",bg='light blue')
    label2.place(x=250,y=170)

    label3=Label(root,text="Address:",bg='light blue')
    label3.place(x=250,y=220)

    label4=Label(root,text="Phone Number:",bg='light blue')
    label4.place(x=250,y=270)

    label5=Label(root,text="Product Name:",bg='light blue')
    label5.place(x=250,y=320)

    label6=Label(root,text="Units:",bg='light blue')
